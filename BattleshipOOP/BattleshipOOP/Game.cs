...
namespace BattleshipOOP
{
    public class Game
    {
        ...
        public void RunGame()
        {
            this.BoardSize = input.GetBoardSize();
            DefinePlayers();
            DefineBoards();
        ...
        {
            Player1 = new Player(isHuman ? input.GetPlayerName() : "Player1", isHuman);
            Player2 = new Player(isHuman ? input.GetPlayerName() : "Player2", isHuman);
        ...
        private void Round()
        {
            ...
            Square selectedSquare = GetSquareByCoordinates(input.GetLocation(), board);
